...
const MonthCard = ({month, year, reading, readingDate, paid, prevReading}) => {
	...
	return (
		<div className={`flex flex-col gap-6 p-6 rounded-xl shadow hover:scale-105 duration-300 ${isPaidBg}`}>
			...
			<div className="flex justify-between items-start">
				<div className="flex gap-3 items-center">
					...
					<h3 className="font-semibold leading-tight whitespace-pre-line">
						{isPaid ? 'Paid.\nThank you!' : 'Payment\nOverdue'}
					</h3>
				</div>
				<div
					className={`flex text-xs gap-2 items-center rounded-full px-3 py-1
			...
			<div className="flex justify-between items-start">
				<div className="flex flex-col gap-1">
					...
					<p className="text-2xl font-semibold">{reading}
			...
			<div className="flex justify-between items-end pt-6 border-t border-gray-200">
				<div className="uppercase leading-none text-sm">Total amount</div>
				<div
