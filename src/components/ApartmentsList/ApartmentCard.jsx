...
const ApartmentCard = ({ apartment }) => {
	...
	return (
		<>
			<div className="relative flex flex-col sm:flex-row gap-0 md:gap-2 p-6 py-8 rounded-lg bg-white hover:shadow-md hover:shadow-slate-200 transition-all duration-300">
				{userRole === 'admin' && (
