		...
		<div className="flex w-full items-center h-screen">
			<div className="w-full flex max-w-screen-xl lg:min-h-[700px] mx-auto bg-white rounded-3xl overflow-hidden shadow-sm">
					<div
						...
						style={{
							backgroundImage: "linear-gradient(-210deg, rgba(97, 122, 255, 0) 9.54%, rgba(97, 122, 255, 0.50) 39.2%, rgba(97, 122, 255, 0.07) 67.55%)",
						}}
					>
							<div className="relative z-10 w-full space-y-24">
									...
									<div className="space-y-8">
											<h2 className="text-white text-5xl font-bold leading-tight">
												Your <span className="mb-0 text-transparent bg-clip-text bg-gradient-to-r from-[#6179FF] to-[#62B4FF]">water</span>,<br/>
												your stats, your control.
											</h2>
											<p className="text-white font-light text-md">
													A simple app for tracking and managing water consumption in our condominium, on <strong>Marte 30</strong>.<br/><br/>
					...
					<div className="flex-1 flex items-center justify-center px-6 py-10 lg:p-16">
							<div className="w-full max-w-md px-4 bg-white text-gray-600 sm:px-0">
									...
									<div className="space-y-3 mb-8">
											<h2 className="text-gray-800 text-2xl font-bold sm:text-4xl mt-0">Welcome back!</h2>
											<p>Log in to view your apartment water consumptions.</p>
									</div>
									<form onSubmit={submit} className="space-y-8">
											...
											<div>
													...
													/>
													<a href="#" className="pt-3 text-sm inline-block text-wom-primary hover:underline">Forgot your password?</a>
											</div>
